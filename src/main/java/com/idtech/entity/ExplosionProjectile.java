...
public class ExplosionProjectile extends ThrowableItemProjectile implements ItemSupplier {
  ...
  public ExplosionProjectile(EntityType<ExplosionProjectile> type, Level level) {super(type, level);}
  ...
  protected void onHit(HitResult hitResult) {
    ...
    if(!this.level.isClientSide) {
      ...
      level.explode(null, pos.x(), pos.y(), pos.z(), 100, Explosion.BlockInteraction.DESTROY);
    }
